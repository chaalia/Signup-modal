...
import * as sty from "./PlasmicDescription.module.css"; // plasmic-import: NghF3nLKMnn/css
  ...
  return (
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <PlasmicLogoIcon
            className={classNames(defaultcss.all, sty.svg___1QOLm)}
            role={"img"}
          />
        ),
