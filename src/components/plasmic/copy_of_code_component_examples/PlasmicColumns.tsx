...
import * as sty from "./PlasmicColumns.module.css"; // plasmic-import: y4i2wU8BJ8FX/css
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          ...
          >
            <YouTube
              className={classNames("__wab_instance", sty.youTube___1MH1F)}
      ...
      {p.renderPlasmicSlot({
        defaultContents: (
          <ListItem
            ...
            className={classNames("__wab_instance", sty.listItem__qmVvd)}
            title={"Google Maps"}
          >
            <GoogleMap
              center={{ lat: -5, lng: -40 }}
