...
import * as sty from "./PlasmicListItem.module.css"; // plasmic-import: -oP-bZni7oo/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__u8Eqq, {
          [sty.freeBox__noBody__u8Eqqs4CdP]: hasVariant(
            variants,
            "noBody",
            "noBody"
          )
      ...
      >
        ...
        {p.renderPlasmicSlot({
          ...
          value: args._package,
          className: classNames(sty.slotTargetPackage)
        })}
      </p.Stack>

      {(hasVariant(variants, "noBody", "noBody") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox__ewvri, {
            [sty.freeBox__noBody__ewvris4CdP]: hasVariant(
              variants,
              "noBody",
              "noBody"
            )
