...
function PlasmicPricingFeatureTableRow__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.freeBox__qtTw9, {
      ...
      >
        <div className={classNames(defaultcss.all, sty.freeBox__mepxl)}>
          {p.renderPlasmicSlot({
        ...
        {false ? (
          <div className={classNames(defaultcss.all, sty.freeBox__mxYpr)}>
        ...
        <div
          className={classNames(defaultcss.all, sty.freeBox___6COYr, {
        ...
        <div
          className={classNames(defaultcss.all, sty.freeBox__kNdEw, {
        ...
        <div
          className={classNames(defaultcss.all, sty.freeBox__bnx1R, {
