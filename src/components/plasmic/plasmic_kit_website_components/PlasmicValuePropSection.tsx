...
function PlasmicValuePropSection__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.freeBox__qQnIe, {
          [sty.freeBox__backgroundColor_blue2__qQnIe2MZuk]: hasVariant(
            variants,
            "backgroundColor",
            "blue2"
          ),
          [sty.freeBox__backgroundColor_blue__qQnIeulOvg]: hasVariant(
            variants,
            "backgroundColor",
            "blue"
          ),
          [sty.freeBox__backgroundColor_green__qQnIEhLRbw]: hasVariant(
            variants,
            "backgroundColor",
            "green"
          ),
          [sty.freeBox__backgroundColor_teal__qQnIEkGhQo]: hasVariant(
            variants,
            "backgroundColor",
            "teal"
          ),
          [sty.freeBox__backgroundColor_yellow__qQnIEuIRhS]: hasVariant(
            variants,
            "backgroundColor",
            "yellow"
          ),
          [sty.freeBox__extras_centerAligned__qQnIetwsav]: hasVariant(
            variants,
            "extras",
            "centerAligned"
          ),
          [sty.freeBox__extras_withExtraSlot1__qQnIeVufcP]: hasVariant(
            variants,
            "extras",
            "withExtraSlot1"
          )
      ...
      >
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox___9IxVq, {
            [sty.freeBox__extras_centerAligned___9IxVqtwsav]: hasVariant(
              variants,
              "extras",
              "centerAligned"
            )
        ...
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox__f8H6D, {
              [sty.freeBox__extras_centerAligned__f8H6DTwsav]: hasVariant(
                variants,
                "extras",
                "centerAligned"
              ),
              [sty.freeBox__global_theme_altHeadlineFont__f8H6DFQkvX]:
                hasVariant(globalVariants, "theme", "altHeadlineFont")
            })}
          >
            <div className={classNames(defaultcss.all, sty.freeBox__tgw42)}>
              {p.renderPlasmicSlot({
            ...
            <div className={classNames(defaultcss.all, sty.freeBox__quuat)}>
              {p.renderPlasmicSlot({
                defaultContents:
            ...
            <div className={classNames(defaultcss.all, sty.freeBox__earlC)}>
              {p.renderPlasmicSlot({
                defaultContents:
          ...
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox__sSdcT)}
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <ButtonLink
