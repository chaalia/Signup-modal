  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__vEe6Y)}
      >
        <div className={classNames(defaultcss.all, sty.freeBox__o5Hv)}>
          <div className={classNames(defaultcss.all, sty.freeBox__rp92I)}>
            {p.renderPlasmicSlot({
