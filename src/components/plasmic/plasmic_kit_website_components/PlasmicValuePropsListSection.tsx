...
function PlasmicValuePropsListSection__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.freeBox__sTac9)}>
        {p.renderPlasmicSlot({
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__hIgK, {
          [sty.freeBox__evenSplit__hIgKNubwn]: hasVariant(
            variants,
            "evenSplit",
            "evenSplit"
          )
      ...
      >
        ...
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox___2Dl5S)}
          >
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(defaultcss.all, sty.freeBox___0CTpv)}
            >
              {p.renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
                    ...
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(defaultcss.all, sty.freeBox__e7JFe)}
                    >
                      <GraphicIcon
                        className={classNames(
                          "__wab_instance",
                    ...
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(defaultcss.all, sty.freeBox__is60X)}
                    >
                      <GraphicIcon
                        className={classNames(
                          "__wab_instance",
        ...
        {false ? (
          <div className={classNames(defaultcss.all, sty.freeBox__m8FK)}>
            <div className={classNames(defaultcss.all, sty.freeBox__lsKij)}>
              <img
        ...
        <div
          className={classNames(defaultcss.all, sty.freeBox__cQYiv, {
            [sty.freeBox__evenSplit__cQYivNubwn]: hasVariant(
              variants,
              "evenSplit",
              "evenSplit"
            )
        ...
        >
          <div className={classNames(defaultcss.all, sty.freeBox__nsS5V)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <img
                  alt={""}
