      ...
      >
        {false ? (
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox__yZcn)}
          >
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(defaultcss.all, sty.freeBox__pfTuy)}
            >
              <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__btz5D)}
        >
          {(
          ...
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox__ux32X, {
              [sty.freeBox__global_theme_altHeadlineFont__ux32XfQkvX]:
          ...
          >
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(defaultcss.all, sty.freeBox__ukaDt)}
            >
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.freeBox__xnUYy, {
                  [sty.freeBox__global_theme_dark__xnUYyH5AZc]: hasVariant(
                    globalVariants,
                    "theme",
                    "dark"
                  )
              ...
              >
                {false ? (
                  <div
                    className={classNames(defaultcss.all, sty.freeBox___8KRCf)}
                  >
                    <div
                      className={classNames(
                        defaultcss.all,
                        ...
                        sty.text__oPds,
                        {
                          [sty.text__global_theme_dark__oPdsH5AZc]: hasVariant(
                            globalVariants,
                            "theme",
                            "dark"
                          )
                ...
                <div className={classNames(defaultcss.all, sty.freeBox__pwGI)}>
                  <div
                    className={classNames(
                      defaultcss.all,
                      defaultcss.__wab_text,
                      sty.text__xlcS,
                      {
                        [sty.text__global_theme_dark__xlcSH5AZc]: hasVariant(
                          globalVariants,
                          "theme",
                          "dark"
                        )
              ...
              {false ? (
                <div
                  className={classNames(defaultcss.all, sty.freeBox__rQwBu, {
                    [sty.freeBox__global_theme_dark__rQwBuH5AZc]: hasVariant(
                      globalVariants,
                      "theme",
                      "dark"
                    )
                ...
                >
                  <div
                    className={classNames(
                      ...
                      sty.text__wDNhg,
                      {
                        [sty.text__global_theme_dark__wDNhgH5AZc]: hasVariant(
                          globalVariants,
                          "theme",
                          "dark"
                        )
              ...
              {false ? (
                <div
                  className={classNames(defaultcss.all, sty.freeBox__rXfit, {
                    [sty.freeBox__global_theme_dark__rXfitH5AZc]: hasVariant(
                      globalVariants,
                      "theme",
                      "dark"
                    )
                ...
                >
                  <div
                    className={classNames(
                      ...
                      sty.text__v714B,
                      {
                        [sty.text__global_theme_dark__v714Bh5AZc]: hasVariant(
                          globalVariants,
                          "theme",
                          "dark"
                        )
              ...
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.freeBox__yQm6S, {
                  [sty.freeBox__global_theme_dark__yQm6Sh5AZc]: hasVariant(
                    globalVariants,
                    "theme",
                    "dark"
                  )
              ...
              >
                {false ? (
                  <div
                    className={classNames(defaultcss.all, sty.freeBox__kT6P)}
                  >
                    <div
                      className={classNames(
                        defaultcss.all,
                        ...
                        sty.text__kGiLg,
                        {
                          [sty.text__global_theme_dark__kGiLgh5AZc]: hasVariant(
                            globalVariants,
                            "theme",
                            "dark"
                          )
                ...
                <div className={classNames(defaultcss.all, sty.freeBox__ofZ1X)}>
                  <div
                    className={classNames(
                      defaultcss.all,
                      defaultcss.__wab_text,
                      sty.text__nLqHt,
                      {
                        [sty.text__global_theme_dark__nLqHth5AZc]: hasVariant(
                          globalVariants,
                          "theme",
                          "dark"
                        )
                  ...
                  >
                    <div
                      className={classNames(
                        ...
                        sty.text__dkUw,
                        {
                          [sty.text__global_theme_dark__dkUwH5AZc]: hasVariant(
                            globalVariants,
                            "theme",
                            "dark"
                          )
            ...
            <div className={classNames(defaultcss.all, sty.freeBox__g8F9L)}>
              {(
                hasVariant(globalVariants, "theme", "altHeadlineFont")
                  ? false
                  : true
                ...
                >
                  <div
                    className={classNames(
                      ...
                      sty.text__gbj13,
                      {
                        [sty.text__global_theme_altHeadlineFont__gbj13FQkvX]:
                          hasVariant(globalVariants, "theme", "altHeadlineFont")
                      }
                    )}
                  >
              ...
              <div
                className={classNames(
                  ...
                  sty.text___7W8P,
                  {
                    [sty.text__global_theme_dark___7W8Ph5AZc]: hasVariant(
                      globalVariants,
                      "theme",
                      "dark"
                    )
              ...
              <div className={classNames(defaultcss.all, sty.freeBox__mW9T0)}>
