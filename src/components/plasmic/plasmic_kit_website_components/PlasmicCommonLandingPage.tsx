  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(defaultcss.all, sty.freeBox__il5V4)}>
            <TestimonialsTop
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.freeBox__tzvvn)}
              >
                <ValuePropListItem
                  slot={
                    <GraphicIcon
          ...
          <ValuePropSection
            ...
            extraSlot={
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.freeBox__thHta)}
              >
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(defaultcss.all, sty.freeBox__blk3T)}
                >
                  <ValuePropListItem
                    slot={
                      <GraphicIcon
            ...
            title={
              <div
                className={classNames(
                  ...
                  sty.text__pIcle,
                  {
                    [sty.text__global_theme_altHeadlineFont__pIcleFQkvX]:
                      hasVariant(globalVariants, "theme", "altHeadlineFont")
                  }
                )}
              >
        ...
        {false ? (
          <section className={classNames(defaultcss.all, sty.section__o1UJw)}>
            <div className={classNames(defaultcss.all, sty.freeBox__pGcAo)}>
              <img
                alt={""}
