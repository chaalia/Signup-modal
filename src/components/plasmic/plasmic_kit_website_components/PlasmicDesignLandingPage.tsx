      ...
      >
        ...
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox__rmrFy)}
          >
            <SmallValuePropCard
              ...
              description={
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(defaultcss.all, sty.freeBox__d527J)}
                >
                  <div
                    className={classNames(
                      defaultcss.all,
            ...
            <SmallValuePropCard
              ...
              rightImage={"rightImage" as const}
              showcaseImage={
                <div className={classNames(defaultcss.all, sty.freeBox__ynomn)}>
                  <img
                    alt={""}
          ...
          <ValuePropSection
            ...
            extraSlot={
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.freeBox__ivd6B)}
              >
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(defaultcss.all, sty.freeBox___5DAKm)}
                >
                  <ValuePropListItem
                    slot={
                      <GraphicIcon
            ...
            title={
              <div
                className={classNames(
                  ...
                  sty.text__ci9Se,
                  {
                    [sty.text__global_theme_altHeadlineFont__ci9SeFQkvX]:
        ...
        {false ? (
          <section className={classNames(defaultcss.all, sty.section___7SPz1)}>
            <div className={classNames(defaultcss.all, sty.freeBox__kTL)}>
              <img
                alt={""}
