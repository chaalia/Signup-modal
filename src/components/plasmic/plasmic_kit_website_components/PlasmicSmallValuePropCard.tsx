  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__vGm3C, {
          [sty.freeBox__ltr__vGm3Cql0Nf]: hasVariant(variants, "ltr", "ltr"),
          [sty.freeBox__rightImage__vGm3CdScZs]: hasVariant(
            variants,
            "rightImage",
            "rightImage"
          ),
          [sty.freeBox__rightImage_ltr__vGm3CdScZsQl0Nf]:
            hasVariant(variants, "rightImage", "rightImage") &&
            hasVariant(variants, "ltr", "ltr")
        })}
      >
        ...
        <div
          className={classNames(defaultcss.all, sty.freeBox__rfSRg, {
            [sty.freeBox__ltr__rfSRgql0Nf]: hasVariant(variants, "ltr", "ltr"),
            [sty.freeBox__rightImage__rfSRgdScZs]: hasVariant(
              variants,
              "rightImage",
              "rightImage"
            ),
            [sty.freeBox__vertical__rfSRghjU5X]: hasVariant(
              variants,
              "vertical",
              "vertical"
            )
        ...
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox__roI0C, {
              [sty.freeBox__rightImage__roI0CdScZs]: hasVariant(
                variants,
                "rightImage",
                "rightImage"
              ),
              [sty.freeBox__vertical__roI0ChjU5X]: hasVariant(
                variants,
                "vertical",
                "vertical"
              )
          ...
          >
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(defaultcss.all, sty.freeBox___2LjYw, {
                [sty.freeBox__ltr___2LjYWql0Nf]: hasVariant(
                  variants,
                  "ltr",
                  "ltr"
                ),
                [sty.freeBox__rightImage___2LjYWdScZs]: hasVariant(
                  variants,
                  "rightImage",
                  "rightImage"
                ),
                [sty.freeBox__rightImage_ltr___2LjYWdScZsQl0Nf]:
                  hasVariant(variants, "rightImage", "rightImage") &&
                  hasVariant(variants, "ltr", "ltr"),
                [sty.freeBox__vertical___2LjYWhjU5X]: hasVariant(
                  variants,
                  "vertical",
                  "vertical"
                )
            ...
            >
              <div className={classNames(defaultcss.all, sty.freeBox__c1XJd)}>
                <div className={classNames(defaultcss.all, sty.freeBox__ev4I)}>
                  {p.renderPlasmicSlot({
              ...
              <div
                className={classNames(defaultcss.all, sty.freeBox__cTaeG, {
                  [sty.freeBox__ltr__cTaeGql0Nf]: hasVariant(
                    variants,
                    "ltr",
                    "ltr"
                  ),
                  [sty.freeBox__rightImage__cTaeGdScZs]: hasVariant(
                    variants,
                    "rightImage",
                    "rightImage"
                  )
              ...
              >
                {p.renderPlasmicSlot({
                  ...
                  className: classNames(sty.slotTargetDescription, {
                    [sty.slotTargetDescription__ltr]: hasVariant(
                      variants,
                      "ltr",
                      "ltr"
                    ),
                    [sty.slotTargetDescription__rightImage]: hasVariant(
                      variants,
                      "rightImage",
                      "rightImage"
                    )
      ...
      {(hasVariant(variants, "ltr", "ltr") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox___01WCm, {
            [sty.freeBox__ltr___01WCMql0Nf]: hasVariant(variants, "ltr", "ltr"),
            [sty.freeBox__rightImage___01WCMdScZs]: hasVariant(
              variants,
              "rightImage",
              "rightImage"
            ),
            [sty.freeBox__showcaseIsVideo___01WCm5W3Ij]: hasVariant(
              variants,
              "showcaseIsVideo",
              "showcaseIsVideo"
            )
