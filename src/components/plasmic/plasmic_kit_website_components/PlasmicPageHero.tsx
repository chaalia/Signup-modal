  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__dso5W)}
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <GraphicIcon
        ...
        <div className={classNames(defaultcss.all, sty.freeBox__rb3Jg)}>
          {p.renderPlasmicSlot({
        ...
        <div className={classNames(defaultcss.all, sty.freeBox__gEcB)}>
          {p.renderPlasmicSlot({
