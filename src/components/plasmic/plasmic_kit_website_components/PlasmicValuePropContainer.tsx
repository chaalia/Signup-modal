  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__wl33N)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__hlNmg)}
        >
          <div className={classNames(defaultcss.all, sty.freeBox__c3Ngm)}>
            {p.renderPlasmicSlot({
          ...
          <div className={classNames(defaultcss.all, sty.freeBox__pZkQq)}>
            {p.renderPlasmicSlot({
          ...
          <div className={classNames(defaultcss.all, sty.freeBox__veZia)}>
            {p.renderPlasmicSlot({
              defaultContents:
      ...
      <div
        className={classNames(defaultcss.all, sty.freeBox__kIdlr, {
          [sty.freeBox__sections_importTeal__kIdlr9PCxI]: hasVariant(
            variants,
            "sections",
            "importTeal"
          )
