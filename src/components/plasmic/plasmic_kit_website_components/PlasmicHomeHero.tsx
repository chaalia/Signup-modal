    ...
    >
      ...
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__f7VC5)}
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox__hNrIt)}
          >
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(defaultcss.all, sty.freeBox__yzLd4)}
            >
              <div
                className={classNames(defaultcss.all, sty.freeBox__nLvV6, {
                  [sty.freeBox__global_theme_altHeadlineFont__nLvV6FQkvX]:
                    hasVariant(globalVariants, "theme", "altHeadlineFont"),
                  [sty.freeBox__global_theme_dark__nLvV6H5AZc]: hasVariant(
                    globalVariants,
                    "theme",
                    "dark"
                  )
              ...
              >
                <div
                  className={classNames(defaultcss.all, sty.freeBox__c30XQ, {
                    [sty.freeBox__global_theme_altHeadlineFont__c30XQfQkvX]:
                      hasVariant(globalVariants, "theme", "altHeadlineFont"),
                    [sty.freeBox__global_theme_dark__c30XQh5AZc]: hasVariant(
                      globalVariants,
                      "theme",
                      "dark"
                    )
              ...
              <div className={classNames(defaultcss.all, sty.freeBox___1C2Y)}>
                {p.renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(
      ...
      <div
        className={classNames(defaultcss.all, sty.freeBox___13297, {
          [sty.freeBox__global_theme_dark___13297H5AZc]: hasVariant(
            globalVariants,
            "theme",
            "dark"
          )
      ...
      >
        <div className={classNames(defaultcss.all, sty.freeBox__znWmw)}>
          <div className={classNames(defaultcss.all, sty.freeBox__tmEn5)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <img
                  alt={""}
