    ...
    >
      ...
      >
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__kb5Q9, {
            [sty.freeBox__showMobileMenu__kb5Q9FYx6G]: hasVariant(
              variants,
              "showMobileMenu",
              "showMobileMenu"
            )
        ...
        >
            ...
            >
              <div
                className={classNames(
                  ...
                  sty.text__hHwpX,
                  {
                    [sty.text__global_theme_dark__hHwpXh5AZc]: hasVariant(
                      globalVariants,
                      "theme",
                      "dark"
                    )
          ...
          {(
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(defaultcss.all, sty.freeBox__gQ38)}
            >
              {(
                hasVariant(globalVariants, "screen", "mobilePortrait")
                  ? false
      ...
      {(
        ...
        >
          ...
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox__szH3A)}
          >
            {(
              hasVariant(globalVariants, "screen", "mobilePortrait")
                ? true
          ...
          <div className={classNames(defaultcss.all, sty.freeBox__ihjf3)}>
            <Linky
