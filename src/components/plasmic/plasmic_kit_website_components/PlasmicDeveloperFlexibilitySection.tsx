...
function PlasmicDeveloperFlexibilitySection__RenderFunc(props: {
  ...
  return (
    <ValuePropsListSection
      ...
      showcaseImage={
        <div className={classNames(defaultcss.all, sty.freeBox__nVmFp)}>
          <img
      ...
      slot={
        <div
          className={classNames(
            ...
            sty.text__boQLs,
            {
              [sty.text__global_theme_altHeadlineFont__boQLsFQkvX]: hasVariant(
                globalVariants,
                "theme",
                "altHeadlineFont"
              )
      ...
      slot3={
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox___8ZbOi)}
        >
          <ButtonLink
